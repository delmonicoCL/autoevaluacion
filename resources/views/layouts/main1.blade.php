    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-5 collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                  {{-- @if (Auth::check() && Auth::user()->tipus->tipus_usuaris_id =='1')  --}}
            ...
            <div class="col-md-2 collapse navbar-collapse" id="navbarNav">
                <form class="col-md-12 d-md-flex justify-content-md-end mb-2 me-5 botonLogin text-white" role="search">
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item botonLogin text-white">
                                <a class="btn btn-primary botonLogin text-white" href="{{ url('/login')}}">Login</a>
                            </li>
                        @endif
                    </ul>
                </form>
