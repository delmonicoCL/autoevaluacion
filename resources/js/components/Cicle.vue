                ...
                <tbody>
                        ...
                        <tr v-for="cicleFiltrado in ciclos">
                            ...
                            <td>{{ cicleFiltrado.descripcio }}</td>
                              ...
                              <td>
                               <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="actiu" name="actiu"
                                    :checked="cicleFiltrado.actiu" disabled>
                            ...
                            <td>
                                ...
                                <div class="col-8">
                                    <a href="#" class="btn btn-editar naranja text-white" @click="confirmDelete()" >
                        ...
                        <div class="modal-body">
                           <form  >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="sigles" name="sigles" v-model="cicleFiltrado.sigles"
                                        placeholder="Ingrese SIGLA ciclo" required>
                                </div>
                                <div class="form-group">
                                    <label for="nombre">Descripcion</label>
                                    <input type="text" class="form-control" id="descripcio" name="descripcio"  v-model="cicleFiltrado.descripcio"
                                        placeholder="Ingrese descripcion" required>
                                </div>

                              <div class="form-group">
                                    <div class="form-check mt-3">
                                        <label class="form-check-label me-5" for="actiu">Estado</label>
                                         <input type="checkbox" class="form-check-input" id="actiu" name="actiu"  v-model="cicleFiltrado.actiu">
                                    </div>
                                </div>

                                <div class="modal-footer mt-4">
                                    <button type="submit" title="Guardar cambios" class="btn-guardar" @click="insertCiclo()">Guardar</button>
                                </div>
                            </form>
                            <span v-if="isError" class="badge text-bg-warning">{{messageError}}</span>
